...
// Solcap message type constants
pub const SOLCAP_WRITE_ACCOUNT_HDR: u32 = 1;
pub const SOLCAP_WRITE_ACCOUNT_DATA: u32 = 2;
pub const SOLCAP_STAKE_ACCOUNT_PAYOUT: u32 = 4;
pub const SOLCAP_STAKE_REWARDS_BEGIN: u32 = 5;
pub const SOLCAP_WRITE_BANK_PREIMAGE: u32 = 6;
pub const SOLCAP_WRITE_STAKE_REWARD_EVENT: u32 = 7;
pub const SOLCAP_WRITE_VOTE_ACCOUNT_PAYOUT: u32 = 8;
...
mod tests {
    ...
    fn test_struct_sizes() {
        ...
        assert_eq!(mem::size_of::<SolanaAccountMeta>(), 52);
